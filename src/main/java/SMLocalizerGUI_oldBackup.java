...
public class SMLocalizerGUI_oldBackup extends javax.swing.JFrame {

	public SMLocalizerGUI_oldBackup() {
		initComponents();
    ...
    private void initComponents() {
        ...
        BasicInpLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {inputPixelSize, minPixelOverBackground, minimalSignal, totalGain, windowWidth});
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SMLocalizerGUI_oldBackup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new SMLocalizerGUI_oldBackup().setVisible(true);
			}
		});
	}
