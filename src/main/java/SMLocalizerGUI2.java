...
public class SMLocalizerGUI2 extends javax.swing.JFrame {

	public SMLocalizerGUI2() {
		initComponents();
...
//		TranslateIm.MakeIm(corrImStack);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SMLocalizerGUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new SMLocalizerGUI2().setVisible(true);
			}
		});
	}
