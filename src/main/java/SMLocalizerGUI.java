...
public class SMLocalizerGUI extends javax.swing.JFrame {
   ...
   // @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        ParameterRangeLayout.setHorizontalGroup(
            ...
            .addGroup(ParameterRangeLayout.createSequentialGroup()
                ...
                .addGroup(ParameterRangeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(maxPhotonCount, javax.swing.GroupLayout.Alignment.LEADING))
                .addContainerGap())
        );
        ...
        GPUprocess.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        GPUprocess.setText("GPU process");
    ...
    private void ProcessActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        */
        /*for (int id = 0; id < 10; id++){ // verify correct values.         
            checkUserInp(id);
        }*/
        ...
        ArrayList<Particle> Results = localizeAndFit.run(corrImStack, signalStrength, minDistance, gWindow, pixelSize,minPixelOverBkgrnd,totalGain,GPUprocess.isSelected());  //locate and fit all particles.
        ...
        if (doDriftCorrect.isSelected())
        {
            ...
            correctDrift.run(boundry, bins, maxParticles, minParticles, GPUprocess.isSelected()); // drift correct all channels.
        }
        if (doChannelAlign.isSelected())
        {
            ...
            correctDrift.ChannelAlign(boundry, maxParticles, minParticles, GPUprocess.isSelected()); // drift correct all channels.
        }
